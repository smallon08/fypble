...
//import com.example.androidproj001.R;
...
public class DemoActivity extends Activity implements PropertyChangeListener {
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            setalarm(switchPowerService.getManager().getImplementation().getStatus(),0);
             //setmessage(switchPowerService.getManager().getImplementation().getString());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView) findViewById(R.id.demo_imageview);
    ...
    public void propertyChange(PropertyChangeEvent event) {
        if (event.getPropertyName().equals("status")) {
            ...
            times ++;
            player  = MediaPlayer.create(this, R.raw.alarm ); 
            setalarm((Boolean) event.getNewValue(),times);
        }
    }
    ...
    protected void setalarm(final boolean on,final  int time ) {
        runOnUiThread(new Runnable() {
            public void run() {
            	...
            	if ( time > 0  ){
                      ...
                      imageView.setBackgroundColor( Color.parseColor("#9EC942")); 
    ...
    public void showalert(){
 	   ...
 	   alertDialog.setTitle("Blood pressure");
        alertDialog.setMessage("it's time to take blood pressure");
...
/*
        alertDialog.setNegativeButton("¨ú®ø", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
